...
import com.sgaikar.workindia.ui.adapters.GridFoodListAdapter.RecyclerViewHolders

class GridFoodListAdapter(private var foodList: List<FoodItem>) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolders {
        @SuppressLint("InflateParams") val layoutView =
            LayoutInflater.from(parent.context).inflate(R.layout.layout_grid_food_item, null)
